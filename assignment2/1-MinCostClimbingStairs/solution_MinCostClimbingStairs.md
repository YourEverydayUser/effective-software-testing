...
considering the actual cost coming from the cost array. Then we also
have a bug in the loop since we are always incrementing by 1 and not
taking into account if we moved 1 or 2 positions. 
